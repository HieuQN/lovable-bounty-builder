-- Update notification function to include showing request ID in URLs for better routing
...
BEGIN
  ...
  IF NEW.sender_type = 'buyer' THEN
    ...
    notification_url := '/agent-dashboard-new?showing=' || NEW.showing_request_id;
  ELSE
